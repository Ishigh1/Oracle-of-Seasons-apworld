...
from .graveyard_ghost import randomize_ghini
from .hide_and_seek import randomize_hns
from ...common.patching.RomData import RomData
from ...common.patching.z80asm.Assembler import Z80Assembler


def randomize_puzzles(rom: RomData, texts: dict[str, str], assembler: Z80Assembler, room_data: list[bytearray],
                      patch_data: dict[str, Any]) -> None:
